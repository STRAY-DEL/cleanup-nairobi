    ...
    <div>
      ...
      <div className="flex border-b">
        ...
        <button
          ...
          className={`px-4 py-2 text-lg font-medium ${
            activeTab === 'system' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500'
          }`}
        >
          System Settings
        </button>
        <button
          ...
          className={`px-4 py-2 text-lg font-medium ${
            activeTab === 'roles' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500'
          }`}
        >
        ...
        <button
          ...
          className={`px-4 py-2 text-lg font-medium ${
            activeTab === 'integrations' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-500'
          }`}
        >
          Integrations
        </button>
